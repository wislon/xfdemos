...
{
  /// <summary>
  /// Allows you to set colours of things (e.g. switches) based on their
  /// toggled values (true/false).
  /// Based on the effects samples at https://github.com/FormsCommunityToolkit/Effects
  /// </summary>
  public static class ChangeColorEffect
  {
    public static readonly BindableProperty FalseColorProperty = BindableProperty.CreateAttached("FalseColor", typeof(Color), typeof(ChangeColorEffect),
        Color.Transparent, propertyChanged: OnColorChanged);

    public static readonly BindableProperty TrueColorProperty = BindableProperty.CreateAttached("TrueColor", typeof(Color), typeof(ChangeColorEffect),
        Color.Transparent, propertyChanged: OnColorChanged);
